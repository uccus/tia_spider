...
# 石化术=冰封守护 坚守=震慑 防守光环=变速 恢复光环=制裁 滚石=冲撞
...
# 嗜血(撕裂) 割喉？窒息之刃(虚脱) 
# 铁钩(弹跳) 真空(反向) 进攻光环(涤荡光环) 地震(混沌打击)
# 陨石(落石) 崩溃(崩塌) 治疗光波(治疗链接)
# 突袭(闪击) 白熊(战熊) 黑洞弹(坍塌)
wushi_book_h      = ["闪电护盾","窒息之刃","割裂","穿刺风暴","幻影斩击","遁地突刺"]
zhanshi_book_h    = ["挥击","岩石皮肤","神的力量","烧灼","毁灭","嗜血"]
qishi_book_h      = ["惩戒","刚铁意志","神盾","圣光驱散","圣光守护","进攻光环"]
fashi_book_h      = ["雷神之力","流星火雨","暴风雪","寒冰咆哮","寒冬","真空"]
saman_book_h      = ["炎魔","死亡生长","陨石","虚弱","崩溃","地震"]
